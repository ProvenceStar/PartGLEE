...
def load_coco_panoptic_json(json_file, image_dir, gt_dir, meta, dataset_name_in_dict="coco_panoptic"):
    """
    Args:
...
def register_coco_panoptic(
    name, metadata, image_root, panoptic_root, panoptic_json, instances_json=None, dataset_name_in_dict="coco_panoptic",
):
    """
    ...
    DatasetCatalog.register(
        panoptic_name,
        lambda: load_coco_panoptic_json(panoptic_json, image_root, panoptic_root, metadata, dataset_name_in_dict="coco_panoptic"),
    )
