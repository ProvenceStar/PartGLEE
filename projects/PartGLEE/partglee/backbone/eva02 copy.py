...
from .vit_utils import     add_decomposed_rel_pos
...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.xattn:
            ...
            if self.use_rel_pos:
                _B, _N, _num_heads, _C = attn.shape
                attn = add_decomposed_rel_pos(attn.flatten(0,1), q.flatten(0,1), self.rel_pos_h, self.rel_pos_w, (H, W), (H, W), self.interp_type)
                attn = attn.reshape(_B, _N, _num_heads, _C)
...
class D2_EVA02(SimpleFeaturePyramid):
    def __init__(self, cfg, input_shape):
        ...
        super().__init__(
            ...
            out_channels=256,
            scale_factors=(4.0, 2.0, 1.0, 0.5),  # (4.0, 2.0, 1.0, 0.5) in ViTDet
