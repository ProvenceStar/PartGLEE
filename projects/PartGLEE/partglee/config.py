...
def add_partglee_config(cfg):
    """
    Add config for PartGLEE.
    """
    ...
    cfg.MODEL.USE_EARLYFUSION = False
    ...
    cfg.MODEL.MaskDINO.NUM_PART_QUERIES = 10
    ...
    # Unify Object-Part
    cfg.MODEL.MaskDINO.UNIFY_OBJECT_PART = False
    
    # Use Q-Former
    cfg.MODEL.MaskDINO.Q_FORMER = False
    cfg.MODEL.MaskDINO.OBJECT_PART_DECODER_LAYERS = 3
    cfg.MODEL.MaskDINO.TOPK_OBJECT_QUERIES = 50
    cfg.MODEL.MaskDINO.USE_BOX_RESTRICTIONS = True
    ...
    cfg.MODEL.MaskDINO.TEST.OBJECT_PART_TEST_AUGMENTATIONS = False
    cfg.MODEL.MaskDINO.TEST.ORACLE = False
    cfg.MODEL.MaskDINO.TEST.VISUALIZE = False
    ...
    cfg.MODEL.MaskDINO.PART_TRANSFORMER_DECODER_NAME = "MaskDINOPartDecoder"
    cfg.MODEL.MaskDINO.UNIFIED_TRANSFORMER_DECODER_NAME = "UnifiedMaskDINODecoder"
