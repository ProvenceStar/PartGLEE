...
from .ade_part_utils import load_binary_mask
import json
...
# OBJ_BASE_CLASS_NAMES = [c for c in OBJ_CLASS_NAMES]
# BASE_CLASS_NAMES = [c for i, c in enumerate(CLASS_NAMES)]
...
_PREDEFINED_SPLITS = {
    ...
    "ade_obj_part_train": (
        "ADE20KPart234/images/training/",
        "ADE20KPart234/ade20k_instance_train.json",
    ),
    "ade_obj_part_val": (
        "ADE20KPart234/images/validation/",
        "ADE20KPart234/ade20k_instance_val.json",
    )
}
...
def _get_obj_part_meta(cat_list, obj_list):
    ret = {
        ...
        "thing_classes": obj_list + cat_list,
    }
    return ret
