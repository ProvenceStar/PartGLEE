...
from .ade_part_utils import load_binary_mask, load_obj_part_sem_seg, load_pascal_voc_obj_part_sem_seg
...
# OBJ_BASE_CLASS_NAMES = [
#     c for i, c in enumerate(OBJ_CLASS_NAMES)
# ]
# BASE_CLASS_NAMES = [
#     c for i, c in enumerate(CLASS_NAMES)
# ]
...
def register_pascal_part_116(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ...
        DatasetCatalog.register(
            all_name,
            lambda x=image_dir, y=gt_dir: load_pascal_voc_obj_part_sem_seg(
