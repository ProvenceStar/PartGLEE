...
_PREDEFINED_SPLITS_COCO_PANOPTIC = {
    "coco_2017_train_panoptic": (
        ...
        "/home/ipad_video/lijunyi/detr/datasets/coco/panoptic_train2017",
        "/home/ipad_video/lijunyi/detr/datasets/coco/annotations/panoptic_train2017.json",
        # This directory contains semantic annotations that are
        # converted from panoptic annotations.
        # It is used by PanopticFPN.
        # You can use the script at detectron2/datasets/prepare_panoptic_fpn.py
        # to create these directories.
        "/home/ipad_video/lijunyi/detr/datasets/coco/panoptic_semseg_train2017",
    ),
    "coco_2017_val_panoptic": (
        "/home/ipad_video/lijunyi/detr/datasets/coco/panoptic_val2017",
        "/home/ipad_video/lijunyi/detr/datasets/coco/annotations/panoptic_val2017.json",
        "/home/ipad_video/lijunyi/detr/datasets/coco/panoptic_semseg_val2017",
    ),
}
        ...
        ret.append(
            {
                ...
                "dataset_name": dataset_name_in_dict,
            }
        )
...
def register_coco_panoptic_annos_sem_seg(
    ...
    DatasetCatalog.register(
        semantic_name,
        lambda: load_coco_panoptic_json(panoptic_json, image_root, panoptic_root, sem_seg_root, metadata, dataset_name_in_dict='coco_panoptic'),
    )
