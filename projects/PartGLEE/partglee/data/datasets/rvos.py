...
__all__ = ["load_ytvis_json", "register_rytvis_instances"]
...
def register_rytvis_instances(name, metadata, json_file, image_root, has_mask=True, has_expression=False, sot=False):
    """
