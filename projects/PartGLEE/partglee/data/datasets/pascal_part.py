...
_PASCAL_PART = {
    "pascal_part_train": ("/home/ipad_video/lijunyi/VLPart/datasets/pascal_part/VOCdevkit/VOC2010/JPEGImages", "/home/ipad_video/lijunyi/VLPart/datasets/pascal_part/train.json"),
    "pascal_part_train_one": ("/home/ipad_video/lijunyi/VLPart/datasets/pascal_part/VOCdevkit/VOC2010/JPEGImages", "/home/ipad_video/lijunyi/VLPart/datasets/pascal_part/train_one.json"),
    "pascal_part_val": ("/home/ipad_video/lijunyi/VLPart/datasets/pascal_part/VOCdevkit/VOC2010/JPEGImages", "/home/ipad_video/lijunyi/VLPart/datasets/pascal_part/val.json"),
...
def register_all_pascal_part(root):
    for key, (image_root, json_file) in _PASCAL_PART.items():
        register_coco_instances(
            ...
            os.path.join(root, json_file) if "://" not in json_file else json_file,
            os.path.join(root, image_root),
            dataset_name_in_dict='pascal_part',
        )

_PASCAL_PART_OPEN_VOCABULARY = {
    ...
    "pascal_part_val_open_vocabulary": ("pascal_part/VOCdevkit/VOC2010/JPEGImages", "pascal_part/val.json"),
}

def register_all_pascal_part_open_vocabulary(root):
    for key, (image_root, json_file) in _PASCAL_PART_OPEN_VOCABULARY.items():
        register_coco_instances(
            key,
            _get_partimagenet_metadata(key),
            os.path.join(root, json_file) if "://" not in json_file else json_file,
