...
omnilabel_object365 = json.load(open('/home/ipad_video/lijunyi/Detectron2_ST_dino/projects/STAnything/stanything/data/datasets/omnilabel_obj365_descriptions.json','rb'))
omnilabel_coco = json.load(open('/home/ipad_video/lijunyi/Detectron2_ST_dino/projects/STAnything/stanything/data/datasets/omnilabel_coco_descriptions.json','rb'))
omnilabel_openimages =  json.load(open('/home/ipad_video/lijunyi/Detectron2_ST_dino/projects/STAnything/stanything/data/datasets/omnilabel_openimages_descriptions.json','rb'))
omnilabel_all =  json.load(open('/home/ipad_video/lijunyi/Detectron2_ST_dino/projects/STAnything/stanything/data/datasets/omnilabel_all_descriptions.json','rb'))