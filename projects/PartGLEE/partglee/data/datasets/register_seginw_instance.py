...
def load_seginw_json(name, image_root, annot_json, metadata, dataset_name_in_dict='seginw'):
    """
    Args:
...
def register_seginw(
    name, metadata, image_root, annot_json, dataset_name_in_dict):
    DatasetCatalog.register(
        name,
        lambda: load_seginw_json(name, image_root, annot_json, metadata, dataset_name_in_dict),
    )
